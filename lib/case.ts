...
export type CaseRevision = { revisionId: string; lineageId: string; parentRevisionId: string | null; caseId: string; scenario: string; inputHash: string; decisionDigest: string; effectiveModel: EffectiveModel; workers: WorkerResult[]; result: Inspection; analysisEvents: AnalysisEvent[]; lifecycle: LifecycleFacts; createdAt: string };
